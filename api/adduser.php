...
// die;
	...
	mysqli_query($con,"insert into employees(image,name,empid,email,contact,address,usertype,password,creationdate,createdby,lastlogin) values('$filename','$empname','$empcode','$empemail','$empcontact','$empaddress','1','$emppass','$datetime','$userid','$datetime')") or die(mysqli_error($con));
