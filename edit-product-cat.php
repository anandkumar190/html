...
<?php 
  ...
  if(isset($_GET['editid']))
  {
    extract($_GET);
     ...
     $res=mysqli_query($con,"select * from product_cat where id='$editid'");
        ...
        <section class="col-lg-12">
          ...
          <div class="nav-tabs-custom">
            ...
            <ul class="nav nav-tabs pull-left">
              ...
              <li class="active"><a href="#tear-tree-view" data-toggle="tab">Edit Product Category</a></li>
          ...
          <div class="box-body">
           <div class="row">
              ...
              <div class="box-footer">
                ...
                <a href="product-cat" class="btn btn-danger"><span class="fa fa-remove"></span> Back</a>
...
function sendData(){
      ...
      fd.append('id',id);
        ...
        fd.append('prodective_cell',prodective_cell);
             ...
             $.ajax({
                 url: 'api/product_catapi.php?edit',
                 type: 'post',
                 data: fd,
